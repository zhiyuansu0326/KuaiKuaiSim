...
# MERA classes
POLICY_CLASS='MERAPolicy'
CRITIC_CLASS='MERACritic'
BUFFER_CLASS='MERABuffer'
AGENT_CLASS='MERA'

# MERA policy args
MERA_K=100
MERA_TAU=0.7
MERA_SINKHORN_ITER=20
MERA_GUMBEL=0.0
    ...
    do
        ...
        do
            ...
            do
                for SEED in 11
                do
                    file_key=${AGENT_CLASS}_${POLICY_CLASS}_K${MERA_K}_tau${MERA_TAU}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}
                    ...
                    python train_actor_critic.py\
                        ...
                        --mera_sinkhorn_iter ${MERA_SINKHORN_ITER}\
                        --mera_gumbel_noise ${MERA_GUMBEL}\
                        ...
                        --mera_entropy_coef ${MERA_ENTROPY}\
